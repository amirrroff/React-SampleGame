...
const Game = ({ onBack }) => {
  ...
  return (
    <div>
      <IoArrowBack onClick={onBack} className="hover:text-slate-600 text-4xl" />
      <h1 className="text-rose-700 text-4xl font-bold mb-6">Amirrroff Game</h1>
      <button
        className=" border-cyan-500 border-2 bg-cyan-500 rounded-lg px-12 py-2 shadow-2xl hover:bg-cyan-600 text-white text-3xl font-bold"
        onClick={handleCarts}
      >
        Reset
      </button>
